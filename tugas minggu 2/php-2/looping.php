...
<body>
    ...
    <?php 
        ...
        */
        ...
        echo "<p><b>Looping yang pertama Ascending</b></p>";
        $mulai2 = 2;
        while($mulai2 <= 20) {
            echo $mulai2 . "- I Love PHP <br/>";
            $mulai2 +=2;
        };

        echo "<p><b>Looping yang pertama Descending</b></p>";
        while($mulai2 > 2) {
            $mulai2 -=2;
            echo $mulai2 . "- I Love PHP <br/>";
        };
        ...
        */
        ...
        for($k = 0; $k < count($items); $k++) {
            $temp[] = ['id' => $items[$k][0], 'name' => $items[$k][1], 'price' => $items[$k][2], 'description' => $items[$k][3], 'source' => $items[$k][4]];
        };
